...
export default function PopBar({icon,campo,onClick,theme}){
    ...
    return(
        <>
            <div className={`absolute right-0 z-[400] mt-2 mr-2 ${theme === themeLight ? 'modoClaro' : 'modoEscuro'}`}>
                <div className=" border w-fit rounded-md px-1 py-1 ">
                    <div >
